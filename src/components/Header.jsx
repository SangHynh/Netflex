...
const Header = () => {
  return (
    <div className='p-4 bg-black flex items-center justify-between opacity-85'>
      ...
      <div className='flex items-center space-x-4'>
        <input type="text" placeholder='Nhập tên phim...' className='outline-none p-2 text-gray-950' />
        <button className='p-2 text-white bg-blue-500 rounded-md'>Tìm kiếm</button>
      </div>
    </div>
  )
}
